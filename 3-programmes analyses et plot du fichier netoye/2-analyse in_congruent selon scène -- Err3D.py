...
def etude_stimuli(L,R,n):
    ...
    return TR,Errh,TR #pour alléger le programme, la fonction ne retourne que 3 listes. Pour ploter la donnée que vous voulez, il suffit de modifier "Err3D" par ce que vous voulez
